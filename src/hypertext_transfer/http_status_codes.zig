...
pub fn hypertext_transfer_status_codes(allocator: type) type {
    ...
    try http_status_codes.put(HTTP_ONE_HUNDRED_TWO, HTTP_PROCESSING);
    try http_status_codes.put(HTTP_ONE_HUNDRED_THREE, HTTP_EARLY_HINTS);
    try http_status_codes.put(HTTP_TWO_HUNDRED, HTTP_OK);
    try http_status_codes.put(HTTP_TWO_HUNDRED_ONE, HTTP_CREATED);
    try http_status_codes.put(HTTP_TWO_HUNDRED_TWO, HTTP_ACCEPTED);
    try http_status_codes.put(HTTP_TWO_HUNDRED_THREE, HTTP_NON_AUTHORITATIVE_INFORMATION);
    try http_status_codes.put(HTTP_TWO_HUNDRED_FOUR, HTTP_NO_CONTENT);
    try http_status_codes.put(HTTP_TWO_HUNDRED_FIVE, HTTP_RESET_CONTENT);
    try http_status_codes.put(HTTP_TWO_HUNDRED_SIX, HTTP_PARTIAL_CONTENT);
    try http_status_codes.put(HTTP_TWO_HUNDRED_SEVEN, HTTP_MULTI_STATUS);
    try http_status_codes.put(HTTP_TWO_HUNDRED_EIGHT, HTTP_ALREADY_REPORTED);
    try http_status_codes.put(HTTP_TWO_HUNDRED_TWENTY_SIX, HTTP_IM_USED);
    try http_status_codes.put(HTTP_THREE_HUNDRED, HTTP_MULTIPLE_CHOICES);
    try http_status_codes.put(HTTP_THREE_HUNDRED_ONE, HTTP_MOVED_PERMANENTLY);
    try http_status_codes.put(HTTP_THREE_HUNDRED_TWO, HTTP_FOUND);
    try http_status_codes.put(HTTP_THREE_HUNDRED_THREE, HTTP_SEE_OTHER);
    try http_status_codes.put(HTTP_THREE_HUNDRED_FOUR, HTTP_NOT_MODIFIED);
    try http_status_codes.put(HTTP_THREE_HUNDRED_SEVEN, HTTP_TEMPORARY_REDIRECT);
    try http_status_codes.put(HTTP_THREE_HUNDRED_EIGHT, HTTP_PREMANENT_REDIRECT);
    try http_status_codes.put(HTTP_FOUR_HUNDRED, HTTP_BAD_REQUEST);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_ONE, HTTP_UNAUTHORIZED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWO, HTTP_PAYMENT_REQUIRED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_THREE, HTTP_FORBIDDEN);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_FOUR, HTTP_NOT_FOUND);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_FIVE, HTTP_METHOD_NOT_ALLOWED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_SIX, HTTP_NOT_ACCEPTABLE);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_SEVEN, HTTP_PROXY_AUTHENTICATION_REQUIRED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_EIGHT, HTTP_REQUEST_TIMEOUT);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_NINE, HTTP_CONFLICT);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TEN, HTTP_GONE);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_ELEVEN, HTTP_LENGTH_REQUIRED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWELVE, HTTP_PRECONDITION_FAILED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_THIRTEEN, HTTP_CONTENT_TOO_LARGE);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_FOURTEEN, HTTP_URI_TOO_LONG);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_FIFTEEN, HTTP_UNSUPPORTED_MEDIA_TYPE);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_SIXTEEN, HTTP_RANGE_NOT_SATISFIABLE);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_SEVENTEEN, HTTP_EXPECTATION_FAILED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_EIGHTEEN, HTTP_TEAPOT);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWENTY_ONE, HTTP_MISDIRECTED_REQUEST);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWENTY_TWO, HTTP_UNPROCESSABLE_CONTENT);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWENTY_THREE, HTTP_LOCKED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWENTY_FOUR, HTTP_FAILED_DEPENDENCY);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWENTY_FIVE, HTTP_TOO_EARLY);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWENTY_SIX, HTTP_UPGRADE_REQUIRED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWENTY_EIGHT, HTTP_PRECONDITION_REQUIRED);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_TWENTY_NINE, HTTP_TOO_MANY_REQUESTS);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_THIRTY_ONE, HTTP_REQUEST_HEADER_FIELDS_TOO_LARGE);
    try http_status_codes.put(HTTP_FOUR_HUNDRED_FIFTEY_ONE, HTTP_UNAVAILABLE_FOR_LEGAL_REASONS);
    try http_status_codes.put(HTTP_FIVE_HUNDRED, HTTP_INTERNAL_SERVER_ERROR);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_ONE, HTTP_NOT_IMPLEMENTED);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_TWO, HTTP_BAD_GATEWAY);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_THREE, HTTP_SERVICE_UNAVAILABLE);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_FOUR, HTTP_GATEWAY_TIMEOUT);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_FIVE, HTTP_VERSION_NOT_SUPPORTED);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_SIX, HTTP_VARIANT_ALSO_NEGOTIATES);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_SEVEN, HTTP_INSUFFICENT_STORAGE);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_EIGHT, HTTP_LOOP_DETECTED);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_TEN, HTTP_NOT_EXTENDED);
    try http_status_codes.put(HTTP_FIVE_HUNDRED_ELEVEN, HTTP_NETWORK_AUTHENTICATION_REQUIRED);
